---
name: news-extractor
description: Quarantined extractor that turns only operator-pasted excerpts into validated,
  dry research views on volatility, correlation, or tail shape.
tools: mcp__qlab__research_apply_views
---
