---
name: signal-qa
description: Probes a proposed regime or signal interpretation for look-ahead smell, stability across windows, and detector disagreement, then records an advisory decision.
model: inherit
tools:
