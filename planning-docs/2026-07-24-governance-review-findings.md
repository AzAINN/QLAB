...
> **Historical, corrected 2026-09-01.** The vulnerabilities below are stated
> in the present tense of the 2026-07-24 tree and are not current: their
> disposition is in [Resolution status](#resolution-status-2026-07-24) at the
> foot of this file, and #1's headless execution path now refuses a bare
...
1. **Critical — the headless MCP is an agent-reachable, unconfirmed, non-cost-gated execution path.**  
   Files: [.mcp.json:5](.mcp.json:5), [qlab/mcp/server.py:34](qlab/mcp/server.py:34), [qlab/mcp/quant_trader.py:73](qlab/mcp/quant_trader.py:73), [qlab/mcp/quant_trader.py:84](qlab/mcp/quant_trader.py:84).  
...
2. **Critical — owner autopilot and CLI paths execute without human confirmation.**  
   Files: [qlab/autopilot/loop.py:77](qlab/autopilot/loop.py:77), [qlab/autopilot/loop.py:221](qlab/autopilot/loop.py:221), [qlab/ui/server.py:917](qlab/ui/server.py:917), [qlab/autopilot/cli.py:49](qlab/autopilot/cli.py:49).  
...
3. **Critical — checked plans are not revalidated against the current book or drawdown at execution.**  
   Files: [qlab/ui/server.py:284](qlab/ui/server.py:284), [qlab/ui/server.py:307](qlab/ui/server.py:307), [qlab/trader/plan.py:203](qlab/trader/plan.py:203), [qlab/trader/plan.py:211](qlab/trader/plan.py:211).  
...
4. **Critical — execution does not verify that the supplied plan content equals the persisted checked plan.**  
   File: [qlab/trader/plan.py:203](qlab/trader/plan.py:203).  
...
5. **Critical — current positions omitted from the target map are never sold.**  
   File: [qlab/trader/plan.py:122](qlab/trader/plan.py:122).  
...
6. **High — the control drawdown tier is bypassed by interactive previews.**  
   Files: [qlab/governance/referee.py:143](qlab/governance/referee.py:143), [qlab/ui/server.py:231](qlab/ui/server.py:231), [qlab/ui/server.py:253](qlab/ui/server.py:253).  
...
7. **High — Alpaca drawdown is always reported as zero.**  
   File: [qlab/trader/broker.py:140](qlab/trader/broker.py:140).  
...
8. **High — breaker liquidation is impossible despite being explicitly permitted.**  
   Files: [qlab/governance/referee.py:99](qlab/governance/referee.py:99), [qlab/trader/plan.py:127](qlab/trader/plan.py:127), [qlab/trader/plan.py:211](qlab/trader/plan.py:211), [qlab/ui/server.py:223](qlab/ui/server.py:223).  
...
9. **High — `targets_hash` is not exact.**  
   File: [qlab/state/registry.py:91](qlab/state/registry.py:91).  
...
10. **High — workflow referee verdicts are not bound to the workflow’s decision.**  
    File: [qlab/state/registry.py:771](qlab/state/registry.py:771).  
...
11. **High — workflow phases are not actually role-bound at the owner boundary.**  
    Files: [qlab/ui/server.py:204](qlab/ui/server.py:204), [qlab/state/registry.py:659](qlab/state/registry.py:659), [qlab/tui/claude.py:334](qlab/tui/claude.py:334).  
...
12. **High — reconciliation can claim clean/reconciled when broker and ledger disagree.**  
    Files: [qlab/trader/reconcile.py:12](qlab/trader/reconcile.py:12), [qlab/trader/plan.py:250](qlab/trader/plan.py:250), [qlab/trader/plan.py:261](qlab/trader/plan.py:261).  
...
13. **High — the mandated order type is ignored.**  
    Files: [mandate.yaml:35](mandate.yaml:35), [qlab/trader/plan.py:166](qlab/trader/plan.py:166), [qlab/trader/broker.py:152](qlab/trader/broker.py:152).  
...
14. **Medium — hedged books are misclassified as all-cash initial deployments.**  
    File: [qlab/trader/plan.py:134](qlab/trader/plan.py:134).  
...
15. **Medium — `max_orders_per_day` is enforced per plan, not per day.**  
    Files: [qlab/trader/mandate.py:201](qlab/trader/mandate.py:201), [qlab/trader/plan.py:175](qlab/trader/plan.py:175).  
...
16. **Medium — mandate validation has fail-open holes.**  
    Files: [qlab/trader/mandate.py:164](qlab/trader/mandate.py:164), [qlab/trader/mandate.py:173](qlab/trader/mandate.py:173), [qlab/trader/mandate.py:195](qlab/trader/mandate.py:195), [qlab/trader/mandate.py:206](qlab/trader/mandate.py:206).  
...
17. **Medium — requested Alpaca execution silently becomes simulation.**  
    File: [qlab/trader/broker.py:166](qlab/trader/broker.py:166).  
...
18. **Low — the cost gate accepts negative expected cost.**  
    File: [qlab/governance/referee.py:49](qlab/governance/referee.py:49).  
